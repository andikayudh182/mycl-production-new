...
<section class="m-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">MPT-3</li>
        </ol>
    </nav>
</section>
...
<section class="m-5">
    @foreach($QC1 as $QC1)
    <h3>Post Treatment 3 : {{$QC1['KodeProduksi']}}
    </h3>
    <h5>
    ...
    <table class="table m-4">
        ...
        @foreach ($QDetails as $data)
         <tr>
             ...
             <td>{{$data['Warna']}}</td>
             <td><a href="{{route('MPT3-Report', ['id'=>$data['id'],])}}">Report Produksi</a></td>
        </tr>   
        @endforeach
    </table>
    @endforeach

...
<div class="m-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Form Update Sanding</li>
        </ol>
    </nav>
</div>
...
<section class="m-5">
    ...
    <form method="POST" action="{{url('/operator/biobo/monitoring-post-treatment-2/form-sanding-submit', ['id'=>$id, ])}}">
        @csrf
        <div class="row mb-3 ">
        ...
        <div class="row mb-3 ">
            <label for="TanggalSanding" class="col-sm-2 col-form-label col-form-label-sm">Tanggal :</label>
            <div class="col-sm-5">
                <input type="date" name="TanggalSanding" class="form-control form-control-sm" id="colFormLabelSm">
            </div>
        </div>
        <div class="row mb-3 ">

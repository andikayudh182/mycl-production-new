...
<section class="body m-5 align-middle" style="height: 60vh; display: d-block;">
    @include('admin.baglog.BaglogChart')
</section>
...
<section class="mx-auto col-md-3 align-middle" style="height: 80vh;">
    <a href="{{ url('/admin/baglog/CalcRecipe') }}" class="list-group-item list-group-item-action">Recipe Calculator</a><br>
    <a href="{{ url('/admin/baglog/datarecipe') }}" class="list-group-item list-group-item-action">Data Recipe</a><br>
    <a href="{{ url('/admin/baglog/report') }}" class="list-group-item list-group-item-action">Report</a><br>
    <a href="#" class="list-group-item list-group-item-action">Form Data</a>
</section>
@endsection
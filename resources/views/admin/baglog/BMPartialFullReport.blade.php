<div class="container m-2">
    <div class="row">
        <div class="col-md-10" style="float: left; display:inline-block;">
            <h3>Full Baglog Making Report</h3>
        </div>
        <div class="col-md-2 " style="float: right;">
            <button class="btn btn-primary" onclick="ExportToExcelFull('xlsx')">Export</button>
        </div>
    </div>
    <div class="row">
        <div class="table-responsive">
            <table class="table table-bordered" id="tbl_exporttable_to_xls_full">
                <tr>
                    <th colspan="12" style="text-align: center">Order</th>
                    <th colspan="8" style="text-align: center">Actual</th>
                </tr>
                <tr>
                    <th>No</th>

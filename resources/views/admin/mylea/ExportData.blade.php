...
<section class="m-5">
    ...
    <div class="collapse" id="collapseExample">
        <div class="card card-body">
            <form method="GET" action="{{url('/admin/mylea/report/export-data')}}">
                @csrf
                <div class="row mb-3 ">
...
<section class="m-5 container">
    <div class="m-5" id="resume">
        <div class="resumedetails">
            <div class="row">
                <h2>Resume Mylea</h2>
                <h4>Total Produksi Mylea : {{$Resume['Produksi']}}</h4>
                <h4>Total Kontaminasi Mylea : {{$Resume['Kontaminasi']}}</h4>
...
@include('admin.mylea.ExportDataJS')
@endif
@endsection
<script>
            ...
            new docx.TableRow({
                children: [
                    ...
                    new docx.TableCell({
                        ...
                        children: [new docx.Paragraph(test[{{$i}}]['Nama'])],
                    }),
                    new docx.TableCell({
                        width: {
                            size: 3505,
                        ...
                        children: [new docx.Paragraph(test[{{$i}}]['JumlahComposite'] !== null ? test[{{$i}}]['JumlahComposite'].toString() : '0')],
                    }),
                    new docx.TableCell({
                        width: {
                            size: 3505,
    ...
    const doc = new docx.Document({
      sections: [{
        ...
        children: [
          new docx.Paragraph({
            text : 'Composite Production Report',
          ...
          new docx.Paragraph({
            children: [
              new docx.TextRun({
                text : 'Total Produksi Composite \t: ' + resume['Produksi'],
                break: 1,
              }),
              new docx.TextRun({
                text : 'Total Kontaminasi Composite \t: ' + resume['Kontaminasi'],
                break: 1,
              }),
              new docx.TextRun({
    ...
    docx.Packer.toBlob(doc).then(blob => {
      console.log(blob);
      saveAs(blob, "ReportComposite_<?php echo $_GET['TanggalAwal'].'_'.$_GET['TanggalAkhir'];?>.docx");
